...
You have made it to your final case study of this tutorial! This case study demonstrates again how these kinds of techniques are applicable for many diverse kinds of texts. You have analyzed TED talks, Shakespeare's plays, *New York Times* headlines, and now, in this final case study, you are going to use your text mining and sentiment analysis skills on a data set of **lyrics from pop songs over 50 years**. All these texts are very from different each other, but you are able to gain insight in each case because this approach is flexible and powerful.
